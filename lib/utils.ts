...
export function getFormationLevelLabel(level: string): string {
...
export function getFormationCategoryColor(category: string): string {
  const colors: Record<string, string> = {
    aviation: 'bg-blue-100 text-blue-800',
    logistique: 'bg-green-100 text-green-800',
    'sciences-gestion': 'bg-purple-100 text-purple-800',
    qhse: 'bg-orange-100 text-orange-800',
  };
